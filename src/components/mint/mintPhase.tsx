  ...
  useEffect(() => {
    ...
    if (communityPhaseLoading || publicPhaseLoading) {
      ...
      if (currentTime >= Number(publicPhase.startTimestamp)) {
        ...
        console.log("Setting phase to NOT ACTIVE");
        setActivePhase("NOT ACTIVE");
      }
    }
  }, [
    communityPhase,
  ...
  return (
    <div className="flex justify-center items-center h-[80vh]">
      ...
      <div className="grid gap-4">
        ...
        <div>
          <p
            className={`tracking-wider shadow-md text-center font-bold text-[120px] text-white p-5 ${BackWild.className}`}
          >
